...
CREATE TABLE incubeta_ads.fare_prices(
    ...
    org_country_code VARCHAR(3) NULL,
    ...
    dst_country_code  VARCHAR(3) NULL,
    ...
    destination_url_economy_oneway VARCHAR(255) NULL,
    destination_url_premium_oneway VARCHAR(255) NULL,
    destination_url_economy_return VARCHAR(255) NULL,
    destination_url_premium_return VARCHAR(255) NULL,
    destination_city_image_url VARCHAR(255) NULL
) ENGINE=InnoDB;